...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{tex/formal-language.tex}
\input{tex/automata-theory.tex}
\input{tex/symbolic-logic.tex}
\input{tex/proof-theory.tex}
\input{tex/formal-semantics.tex}

\input{tex/computation-theory.tex}
\input{tex/type-theory.tex}
\input{tex/database-theory.tex}

\input{tex/set-theory.tex}
\input{tex/topology.tex}
\input{tex/graph-theory.tex}

\input{tex/category-theory.tex}
\input{tex/abstract-algebra.tex}

\input{tex/number-theory.tex}
\input{tex/analysis.tex}

\input{tex/information-theory.tex}
\input{tex/dynamical-systems.tex}
\input{tex/control-theory.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
