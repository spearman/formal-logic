...
% --------------------------------------------------------------------
\subsection{Real-valued Continuous Function}
\label{sec:realvalued_continuous}
% --------------------------------------------------------------------
...
Equivalently: Continuous at $l$ if and only if $\forall \varepsilon >
0, \exists \delta : |x - l| < \delta \Rightarrow |f(x) - f(l)| <
\varepsilon$
