...
A Sequence $a_n$ Converges (\S\ref{sec:convergent_sequence}) to $l$ if
and only if all Subsequences of $a_n$ Converge to $l$.
...
\paragraph{Squeezing Principle}\label{sec:squeezing_principle}
\hfill \\
...
If a Decreasing Sequence is Bounded below then it is Convergent
