...
Cobweb Plot: qualitative behavior of One-dimensional Iterated Functions
(\S\ref{sec:iterated_function}), e.g. Logistic Map
...
\label{sec:discrete_dynamical_system}
% --------------------------------------------------------------------
...
% --------------------------------------------------------------------
\subsection{Graph Dynamical System}\label{sec:graph_dynamical_system}
% --------------------------------------------------------------------

\subsubsection{Sequential Dynamical System}
\label{sec:sequential_dynamical_system}

\fist Boolean Networks (\S\ref{sec:boolean_netowrk})
