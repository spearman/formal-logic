...
cf. Fractal Geometry (Part \ref{sec:fractal_geometry})
...
\emph{Markov Processes} (\S\ref{sec:markov_process}) --
a State in a Markov Process is \emph{Ergodic} (cf. Ergodic Theory
\S\ref{sec:ergodic_theory}) if it is:
\begin{itemize}
