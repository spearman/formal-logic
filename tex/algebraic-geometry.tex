...
Space of Homogenous Polynomials of Degree $r$ on $V$

cf. Homogenous Differential Equation
(\S\ref{sec:homogenous_differential_equation}),
Homogenous Difference Equation
(\S\ref{sec:homogenous_differential_equation}),
Homogenous System of Linear Equations (\S\ref{sec:homogenous_system})
...
\label{sec:homogenous_system}

cf. Homogenous Polynomial (\S\ref{sec:homogenous_polynomial}), Homogenous
Differential Equation (\S\ref{sec:homogenous_differential_equation}),
Homogenous Difference Equation (\S\ref{sec:homogenous_differential_equation})
...
\fist Projective Variety (Homogenous Polynomials \S\ref{sec:projective_variety})
