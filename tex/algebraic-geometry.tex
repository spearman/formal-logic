...
%FIXME possibly move under vector spaces
...
\subsubsection{Parametric Equation}\label{sec:polynomial_equation}
...
as a Topological Group, an Abelian Variety is a Torus %FIXME 
