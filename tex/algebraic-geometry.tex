...
Set of its Roots (\S\ref{sec:root}), a Geometric Object, in the
...
\emph{Link between ``Algebra'' and ``Geometry''}: a Monic Polynomial (Univariate
with Complex Coefficients \S\ref{sec:monic_polynomial}), an Algebraic Object, is
determined by the Set of its Roots (\S\ref{sec:root}), a Geometric Object, in
the Complex Plane (\S\ref{sec:complex_plane}).
