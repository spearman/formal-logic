...
an Indefinite Quadratic Form is called an \emph{Isotropic Quadratic Form}
(\S\ref{sec:isotropic_quadratic_form})
...
\paragraph{Isotropic Quadratic Form}\label{sec:isotropic_quadratic_form}\hfill

\emph{Indefinite Quadratic Form}

\fist Indefinite Inner Product Space (\S\ref{sec:indefinite_inner_product})
...
all Elementary Functions can be written in terms of $E(x,y) = \exp(x) - \ln(y)$
and $1$ (Odrzywolek 2026)
