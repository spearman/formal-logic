...
\emph{Among Algorithms that Decode Strings from their descriptions (Codes),
  there exists an optimal one.}; can be used to define several Functions of
...
% ------------------------------------------------------------------------------
\subsection{Kolmogorov Complexity}\label{sec:kolmogorov_complexity}
% ------------------------------------------------------------------------------

\emph{Algorithmic Complexity} or \emph{Descriptive Complexity}
