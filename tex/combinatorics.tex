...
taking \emph{Combination} as a Primitive Notion divides Mathematics into roughly
two branches of \emph{Finitary Combinatorics} and \emph{Infinitary
  Combinatorics}, mirroring in some ways the distinction between \emph{Discrete}
and \emph{Continuous} Mathematics:
\begin{itemize}
