...
Pigeon Hole Principle: A Set of Integers $T \subset \mathbb{Z}$ is a
Complete Set of Residues $\mathrm{mod} n$ if $|T| = n$ and no Elements
of a particular Residue $\mathrm{mod} n$ occur more than once.
