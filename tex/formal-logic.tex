...
(Part \sec{part:type_theory}) represent corresponding Logical Operations
...
Model Theory (Part \ref{sec:model_theory}): Universal Algebra
(\S\ref{sec:universal_algebra})

Category Theory (Part \ref{sec:category_theory}): Lawvere Theory
...
(\S\ref{sec:firstorder_logic}) without Quantified Variables
...
equal to Set Theory (Part \S\ref{sec:set_theory})
