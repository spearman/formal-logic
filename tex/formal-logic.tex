...
\subsubsection{Affine Logic}\label{sec:affine_logic}\hfill
...
\paragraph{Hoare Logic}\label{sec:hoare_logic}\hfill
...
\subparagraph{Separation Logic}\label{sec:separation_logic}\hfill
