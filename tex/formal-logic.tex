...
Dual Intuitionistic Linear Logic (Session Types)
...
\begin{itemize}
  ...
  \item $\oplus$ Additive Disjunction (``Plus'', alternative occurence
    of Resources, Internal Choice)
  \item $\&$ Additive Conjunction (``With'', alternative occurence of
    Resources, External Choice)
  \item $\parr$ Additive Disjunction (``Parr'')
...
\paragraph{Statistical Inference}\label{sec:statistical_inference}
\hfill \\
