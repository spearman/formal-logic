...
Validate the Premises also Validate the Conclusion.

A Logical Argument is Valid if and only if its Corresponding
Conditional is a Logical Truth, or equivalently, if and only if the
Conclusion is Logically Entailed (\S\ref{sec:logical_consequence}) by
the Premises.
