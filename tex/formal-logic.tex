...
\paragraph{Many-sorted Signature}\label{sec:manysorted_signature}
\hfill \\
...
\paragraph{Equation}\label{sec:equation}
\hfill \\
...
\paragraph{Equational Theory}\label{sec:equational_theory}
\hfill \\
...
\paragraph{Normal Modal Logic}\label{sec:normal_modal}
\hfill \\
...
\paragraph{Basic Temporal Language (BTL)}\label{sec:btl}
\hfill \\
...
\paragraph{Adjoint Modality}\label{sec:adjoint_modality}
\hfill \\
...
\begin{enumerate}
  \item Call-by-Name (???) (Girard): %FIXME
\[
  (A \rightarrow B)^\circ = !A^\circ \multimap B^\circ
\]
  \item Call-by-value (???): %FIXME
\[
...
\paragraph{Elementary Linear Logic}\label{sec:elementary_linear_logic}

\paragraph{Light Linear Logic}\label{sec:light_linear_logic}
\hfill \\
...
\paragraph{Soft Linear Logic}\label{sec:soft_linear_logic}
