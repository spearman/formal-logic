...
Xi,Wu 2016 -- \emph{Propositions in Linear Multirole Logic as
  Multiparty Session Types}: $\pi LMRL$ (\S\ref{sec:pi_lmrl})

Danielou,Yoshida2011 -- \emph{Dynamic Multirole Session Types}

Multiparty Session Types (\S\ref{sec:multiparty_session})

Communicating Systems (\S\ref{sec:communicating_system})
