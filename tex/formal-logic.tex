...
\paragraph{Ground Term}\label{sec:ground_term}\hfill \\
...
\paragraph{Linear Term}\label{sec:linear_term}\hfill \\

A \emph{Linear Term} is a Term without multiple occurences of a single
Variable.
...
\paragraph{Clause}\label{sec:clause}\hfill \\
