...
\paragraph{Disjunction}\label{sec:disjunction}\hfill \\\hfill

\emph{Disjunction} (also \emph{Alternation} or ``\emph{Logical Or}'')



\paragraph{Conjunction}\label{sec:conjunction}\hfill \\\hfill

\emph{Conjunction} (or ``\emph{Logical And}'')



\paragraph{Material Conditional}\label{sec:material_conditional}\hfill \\\hfill
...
\paragraph{Joint Denial}\label{sec:joint_denial}\hfill \\\hfill

\emph{Joint Denial} or ``\emph{Nor}''



\paragraph{Alternative Denial}\label{sec:alternative_denial}\hfill \\\hfill
...
\paragraph{Quantifier Rank}\label{sec:quantifier_rank}\hfill \\\hfill
...
\paragraph{Prenex Normal Form}\label{sec:prenex_normal}\hfill \\\hfill

Normal Form (\S\ref{sec:normal_form})



\paragraph{Plural Quantification}\label{sec:plural_quantification}\hfill \\\hfill
...
\paragraph{Cardinality}\label{sec:signature_cardinality}\hfill \\\hfill
...
\paragraph{Literal}\label{sec:literal}\hfill \\\hfill
...
\paragraph{Horn Clause}\label{sec:horn_clause}\hfill \\\hfill
...
\paragraph{$\Omega$-logic}\label{sec:omega_logic}\hfill \\\hfill
...
\subparagraph{Computation Tree Logic}\label{sec:computation_tree_logic}\hfill
...
Adjunctions (\S\ref{sec:adjoint}) of Modal Operators: Adjoint Modality
(\S\ref{sec:adjoint_modality})
...
\emph{Theory of Uninterpreted Functions}
...
\paragraph{Classical Linear Logic}\label{sec:cll} \hfill \\\hfill
...
\paragraph{Proposition}\label{sec:proposition}\hfill \\\hfill
