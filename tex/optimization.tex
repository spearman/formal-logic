...
\fist \emph{Bayes Estimator} (\S\ref{sec:bayes_estimator}) -- Estimator
(\S\ref{sec:estimator}) or Decision Rule (\S\ref{sec:decision_rule}) that
minimizes (maximizes) Posterior Expected Value of a Loss (Utility) Function
