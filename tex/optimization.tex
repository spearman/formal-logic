...
\subsubsection{Trust Region}\label{sec:trust_region}

\subsubsection{Line Search}\label{sec:line_search}

\paragraph{Backtracking Line Search}\label{sec:backtracking_line_search}\hfill
