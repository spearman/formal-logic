...
\subsubsection{Incidence}\label{sec:graph_incidence}
...
\subsubsection{Simple Path}\label{sec:simple_path}
...
A \emph{Topological Ordering} or \emph{Topological Sorting} is a Total Ordering,
$\leq_T$, of the Vertices such that $\forall (u,v) \in E \Rightarrow (u,v) \in
\leq_T$. A Topological Ordering is a Linear Extension of the DAG's Partial
Ordering. % FIXME ref linear extension
...
is equal to the Degree Matrix minus the Adjacency Matrix

$L = D - A$

Laplacian Matrix is a Difference Operator (\S\ref{sec:difference_operator})
...
% ------------------------------------------------------------------------------
\subsection{Graph Pebbling}\label{sec:graph_pebbling}
% ------------------------------------------------------------------------------
