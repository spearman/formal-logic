...
(\S\ref{sec:inference_rules}) from a Set of zero or more
\emph{Axioms} (\S\ref{sec:axiomatization}). The Rules of Inference
...
\emph{Logical Implication}, \emph{Entailment}

\emph{Syntactic Consequence}, \emph{Semantic Consequence}



\subsubsection{Material Implication}\label{sec:material_implication}

\emph{Material Conditional}, \emph{Implication}
...
Inference Rules of a Propositional Logic define Valid \emph{Argument
  Forms} (\S\ref{sec:inference_rules}). The simplest Argument Form
