%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Symbolic Logic}\label{sec:symbolic_logic}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\emph{Symbolic Logic} or \emph{Formal Logic} utilizes Formal Language
(Part \ref{sec:formal_language}) to develop \emph{Inferences}
(\S\ref{subsec:inference_rules}) from a Set of zero or more
\emph{Axioms} (\S\ref{subsec:axiomatization}). The Rules of Inference
and Axioms form a \emph{Deductive Apparatus}
(\S\ref{subsec:deductive_apparatus}).
...
% --------------------------------------------------------------------
\subsection{Metavariable}\label{subsec:metavariable}
% --------------------------------------------------------------------
...
\paragraph{Noncommutative Logic}\label{subsec:noncommutative_logic}
