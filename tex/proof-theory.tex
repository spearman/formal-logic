...
that relate a number of \emph{Primitive Terms} so that a Consistent
Theory (\S\ref{sec:consistency}) may be Deductively Derived from these
Statements, and thereafter the Proof of any Proposition should be traceable back
to these Axioms
