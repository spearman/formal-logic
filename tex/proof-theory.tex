...
\emph{Proof Theory} analyzes \emph{Deductive Arguments} in the form of
\emph{Formal Proofs} (\S\ref{sec:formal_proof}). Deductive Arguments
proceed by \emph{Syntactic Consequence}
(\S\ref{sec:logical_consequence}) to make \emph{Deductive Inferences}
(\S\ref{sec:mathematical_inference}).
...
\subsubsection{Logical Harmony}\label{sec:logical_harmony}
