...
In the context of a Deductive System, $\mathcal{S}$, a \emph{Deductive
  Theory} (or \emph{Inductive Class}), $T$, is a \emph{Formal Theory}
(\S\ref{sec:formal_theory}) that consists of all the Theorems that are
Derivable in $\mathcal{S}$, including any Axioms.
