...
\emph{Proof Theory} analyzes \emph{Deductive Arguments}
(\S\ref{sec:deductive_logic}) in the form of \emph{Formal Proofs}
(\S\ref{sec:formal_proof}). Deductive Arguments proceed by
\emph{Syntactic Consequence} (\S\ref{sec:logical_consequence}) to make
\emph{Deductive Inferences} (\S\ref{sec:deductive_inference}).
