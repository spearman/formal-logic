...
\emph{Proof Theory} studies \emph{Deductive Arguments} in the form of
...
Proof by \emph{Syntactic Consequence} (a form of \emph{Logical
  ...
  Inference} (\S\ref{sec:mathematical_inference}).
...
(\S\ref{sec:deductive_apparatus}) in order to \emph{Derive}
\emph{Theorems} (\S\ref{sec:formal_proof}). Here, Expressions
...
\emph{Interpretation} (\S\ref{sec:interpretation}). The set of
...
Deduction proper is the top-down, \emph{Reductive}
(\S\ref{sec:abstract_rewrite}) process that starts with general Axioms
and Reduces to the specific Theorem that is being proved.


% --------------------------------------------------------------------
\subsection{Axioms}\label{sec:axiomatization}
% --------------------------------------------------------------------
...
\emph{Logical Assertion}(\S\ref{sec:sequent_notation}).
...
% --------------------------------------------------------------------
\subsection{Inference Rules} \label{sec:inference_rules}
% --------------------------------------------------------------------
...
\begin{enumerate}
\item Rely on the Logical Form (\S\ref{sec:inference_rules}) of the
  Expressions
...
Admissible Rule (\S\ref{sec:inference_rules}).
