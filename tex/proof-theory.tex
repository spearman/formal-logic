...
% --------------------------------------------------------------------
\subsection{Proof Calculus}\label{sec:proof_calculus}
% --------------------------------------------------------------------
...
\begin{itemize}
  \item Axiomatic System (\S\ref{sec:axiomatic_system})
  \item Structural Proof Theory (\S\ref{sec:structural_proof})
  \item Tableau Calculus (\S\ref{sec:tableau_calculus})
\end{itemize}
...
% ====================================================================
\section{Axiomatic System} \label{sec:axiomatic_system}
% ====================================================================
...
% --------------------------------------------------------------------
\subsection{Hilbert Systems}\label{sec:hilbert_systems}
% --------------------------------------------------------------------
...
% ====================================================================
\section{Structural Proof Theory}\label{sec:structural_proof}
% ====================================================================
...
% --------------------------------------------------------------------
\subsection{Natural Deduction}\label{sec:natural_deduction}
\cite{prawitz65}
% --------------------------------------------------------------------
...
% --------------------------------------------------------------------
\subsection{Sequent Calculus}\label{sec:sequent_calculus}
% --------------------------------------------------------------------
...
\subsubsection{Sequent Notation}\label{sec:sequent_notation} \hfill \\
...
\subsubsection{Cut Elimination}\label{sec:cut_elimination} \hfill \\
...
\subsubsection{$\mathbf{LK}$}\label{sec:lk} \hfill \\
...
\subsubsection{$\mathbf{LJ}$}\label{sec:lj} \hfill \\
...
\subsubsection{Substructural Rule Sets}\label{sec:substructural_rule} \hfill \\
...
% --------------------------------------------------------------------
\subsection{Calculus of Structures}\label{sec:calculus_of_structures}
% --------------------------------------------------------------------
...
% ====================================================================
\section{Tableau Calculus}\label{sec:tableau_calculus}
% ====================================================================
...
% --------------------------------------------------------------------
\subsection{Refutation Tableau}\label{sec:refutation_tableau}
% --------------------------------------------------------------------
...
% --------------------------------------------------------------------
\subsection{Destructive \& Non-destructive Tableau}
...
% --------------------------------------------------------------------
\subsection{Proof Confluence} \label{sec:proof_confluence}
% --------------------------------------------------------------------
...
% --------------------------------------------------------------------
\subsection{Clause Tabeau} \label{sec:clause_tableau}
% --------------------------------------------------------------------
...
\subsubsection{Connection Tableau} \label{sec:connection_tableau}
