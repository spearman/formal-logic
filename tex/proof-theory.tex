...
% --------------------------------------------------------------------
\subsection{Geometry of Interactions} \label{sec:geometry_of_interaction}
% --------------------------------------------------------------------
...
Bounded version of Geometry of Interactions
...
and Error Stops (???) as Effects (???), Realizability and Focalization
give the same Meaning to Types.
