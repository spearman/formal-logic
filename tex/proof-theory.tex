...
\emph{Proof Theory} studies \emph{Deductive Arguments} or
\emph{Proofs} (\S\ref{subsec:formal_proof}).

Proof by \emph{Syntactic Consequence} (a form of \emph{Logical
  Consequence}) is a \emph{Deduction}; that is, the production of a
Theorem is said to be a \emph{Derivation}. Deduction proper is the
top-down, \emph{Reductive} process that starts with general Axioms and
Reduces to the specific Theorem that is being proved.
