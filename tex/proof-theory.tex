...
\subsubsection{Metatheorem}\label{sec:metatheorem}

A \emph{Metatheorem} is a Theorem proved within a Metatheory.



\subsubsection{Judgement}\label{sec:judgement}
...
% --------------------------------------------------------------------
\subsection{Direct Proof}\label{sec:direct_proof}
% --------------------------------------------------------------------

% --------------------------------------------------------------------
\subsection{Indirect Proof}\label{sec:indirect_proof}
% --------------------------------------------------------------------
