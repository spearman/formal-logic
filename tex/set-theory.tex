...
\subsubsection{Intension}\label{sec:intension}

\subsubsection{Predicate}\label{sec:predicate}

\subsubsection{Subject}\label{sec:subject}

\subsubsection{Property}\label{sec:property}

\emph{Properties} (or \emph{Predicables}) are Objects that can be
Predicated (\S\ref{sec:predicate}) of other Objects (\emph{Subjects}).
The Predicate or \emph{Indicator Function}
...
\paragraph{Knaster-Tarski Theorem}\label{sec:knaster_tarski}
\hfill \\
...
\subsubsection{Free Lattice}\label{sec:free_lattice}
