...
\emph{Individual} or \emph{Urelement} (\S\ref{sec:urelement}).
...
\subsubsection{Symmetric Difference}\label{sec:symmetric_difference}
...
\subsubsection{Relative Complement}\label{sec:relative_complement}
...
the Relative Complement defined with $A$ and the given Universe,
$\mathbf{U}$.
...
\subsubsection{Cartesian Product}\label{sec:cartesian_product}
...
% --------------------------------------------------------------------
\subsection{Noetherian Relation}\label{sec:noetherian_relation}
% --------------------------------------------------------------------
...
\subsubsection{Axiom of Extensionality}\label{sec:extensionality_axiom}
\[
    \forall S \forall T
