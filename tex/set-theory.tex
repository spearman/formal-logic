...
\subsubsection{Well-founded Relation}\label{subsec:well_founded}
...
% --------------------------------------------------------------------
\subsection{Lattice Theory}\label{subsec:lattice_theory}
% --------------------------------------------------------------------
...
% --------------------------------------------------------------------
\subsection{Order Ideal}\label{subsec:order_ideal}
% --------------------------------------------------------------------
...
\subsubsection{Antimatroid}\label{subsec:antimatroid}
