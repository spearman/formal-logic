...
(\S\ref{sec:quine_atom}) $Q = \{Q\}$. \cite{aczel88} %FIXME ref
hereditarily finite
...
(\S\ref{sec:accessible_pointed}) corresponds to (the Membership
Structure of) a Unique Set (every Graph has a Unique Decoration);
Maximal Bisimulation Relation %FIXME
