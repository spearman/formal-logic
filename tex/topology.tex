...
\subsubsection{Nerve}\label{sec:covering_nerve}
...
\fist cf. \empy{Polytope Density} (\S\ref{sec:polytope density}) --
...
a Tychonoff Space (Completely $\xspace_{3}$ Space \S\ref{sec:tychonoff_space})
is a Completely Regular Hausdorff Space (\S\ref{sec:hausdorff_space})
...
Tychonoff Space (Completely $\xspace_{3}$ Space) is a Completely Regular
Hausdorff Space (\S\ref{sec:hausdorff_space})
...
cf. Topological Manifold (\S\ref{sec:topological_manifold})

%FIXME: merge with topological manifold ???
...
\subsubsection{Differentiable Curve}\label{sec:differentiable_curve}
