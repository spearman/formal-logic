...
a Topological Space (which may also be a Separated Space
\S\ref{sec:hausdorff_space}) which \emph{Locally} resembles Real
$n$-dimensional Space
...
\emph{Atlas} of Homeomorphisms called \emph{Charts};
and a Topological Manifold is such a Space with an Equivalence Class of Atlases
...
\subsubsection{Smooth Atlas}\label{sec:smooth_atlas}\hfill

a \emph{Smooth Atlas} for a Topological



\subsubsection{Smooth Structure}\label{sec:smooth_structure}\hfill
...
the Dimension of the Tangent Space of a Connected Manifold is the same as that
...
a Riemannian Metric or Symplectic Form gives rise to a Natural Isomorphism
between the Tangent Space and the Cotangent Space at a Point
