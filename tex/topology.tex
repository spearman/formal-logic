...
\paragraph{Fiber}\label{sec:point_fiber}
\hfill \\
...
\paragraph{Universal Cover}\label{sec:universal_cover}
\hfill \\
...
\paragraph{Rose}\label{sec:rose}

\paragraph{Sphere Boquet}\label{sec:sphere_boquet}
...
\paragraph{Classifying Morphism}\label{sec:classifying_morphism}
\hfill \\
