...
\paragraph{Metric Tensor}\label{sec:metric_tensor}\hfill

\subparagraph{Positive Definite Metric Tensor}
\label{sec:positive_definite_metric_tensor}\hfill

Positive Definite Quadratic Form (\S\ref{sec:definite_quadratic_form})
...
\paragraph{Riemannian Manifold}\label{sec:riemannian_manifold}\hfill
...
\subparagraph{Riemannian Metric}\label{sec:riemannian_metric}\hfill

for a Differentiable Manifold $M$ of Dimension $n$, a \emph{Riemannian
  Metric} is a Family of Positive Definite
(\S\ref{sec:definite_quadratic_form}) Inner Products
...
\paragraph{Submersion}\label{sec:submersion}\hfill
...
\paragraph{Immersion}\label{sec:immersion}\hfill
...
Manifold with a Positive Definite Metric Tensor
...
\paragraph{Pseudo-Riemannian Manifold}
\label{sec:pseudo_riemannian}\hfill
...
\subparagraph{Lorentzian Manifold}\label{sec:lorentzian_manifold}
\hfill
...
\paragraph{Symplectic Manifold}\label{sec:symplectic_manifold}\hfill

\emph{Symplectic Form} $\omega$ -- Closed Non-degenerate Differential
2-form %FIXME
