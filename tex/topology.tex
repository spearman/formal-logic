...
1-dimensional (Knot Theory \S\ref{sec:knot_theory}):
...
\subsubsection{Chart}\label{sec:chart}
...
\paragraph{Transition Map}\label{sec:transition_map}\hfill

\paragraph{Smooth Atlas}\label{sec:smooth_atlas}\hfill

a \emph{Smooth Atlas} for a Topological



\paragraph{Smooth Structure}\label{sec:smooth_structure}\hfill
...
\subparagraph{Exotic Smooth Structure}\label{sec:exotic_smooth_structure}\hfill
