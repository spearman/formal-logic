...
\[
  \mathcal{I} \models \mathcal{T} \Rightarrow \mathcal{I} \models \varphi
\]
...
% --------------------------------------------------------------------
\subsection{Supervaluation}\label{sec:supervaluation}
% --------------------------------------------------------------------
...
\subsubsection{Definition}\label{sec:set_definition}
...
A Function (\S\ref{sec:set_function}) is Well-defined if changing the
