...
% ====================================================================
\section{Semantic Consequence}\label{sec:semantic_consequence}
% ====================================================================
...
\emph{Satisfies} (\S\ref{sec:satisfaction}) both $T$ and $\varphi$,
that is, $\varphi$ is True in all Models of $T$.

A \emph{Tautology} is expressed as
\[
    \vDash {\varphi}
\]
...
% --------------------------------------------------------------------
\subsection{Valuation}\label{sec:model_valuation}
% --------------------------------------------------------------------
...
% --------------------------------------------------------------------
\subsection{Normalization \& Confluence}
\label{sec:normalization_confluence}
% --------------------------------------------------------------------



% --------------------------------------------------------------------
\subsection{Deductive $\lambda$-Calclulus}\label{sec:deductive_lambda}
% --------------------------------------------------------------------
...
(Predicate \S\ref{sec:predicate}) or a Relation
(\S\ref{sec:relation}).
...
(\S\ref{sec:connotation}) by a Symbol or Formula.
...
\paragraph{Definite Description}\label{sec:definite_description}

\paragraph{Indefinite Description}\label{sec:indefinite_description}
