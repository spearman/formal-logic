...
\HandRight\; Cf. Denotational Semantics
...
A Function (\S\ref{sec:computable_function}) is Well-defined if
changing the input representation while leaving the input Value
