...
% --------------------------------------------------------------------
\subsection{Denotation}\label{sec:denotation}
% --------------------------------------------------------------------
...
% --------------------------------------------------------------------
\subsection{Connotation}\label{sec:connotation}
% --------------------------------------------------------------------

\emph{Connotation} is a Second-order Denotation
...
Peircean (Sign, Object, Interpretant)
...
\paragraph{Seme}\label{sec:seme}

\paragraph{Sememe}\label{sec:sememe}

\paragraph{Semiosis}\label{sec:semiosis}
