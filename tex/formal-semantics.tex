...
over a given Signature (\S\ref{sec:signature}). In Category Theory a
Term Algebra is an Initial Algebra (\S\ref{sec:initial_algebra}) for
the Category of all Algebras with a given Signature.
...
Formulas (\S\ref{sec:atomic_formula}) in which only Ground Terms
appear).
