...
One definition of \emph{Model Theory} is the combination of Formal
Logic with \emph{Universal Algebra} (\S\ref{sec:universal_algebra}).
An alternative view of Model Theory equates it with \emph{Algebraic
