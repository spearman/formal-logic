...
Set Theory (Part \ref{part:set_theory}) as Linear Algebra over the
...
% --------------------------------------------------------------------
\subsection{Interior Product}\label{sec:interior_product}
% --------------------------------------------------------------------

or \emph{Interior Derivative}

Degree $-1$ Antiderivation on the Exterior Algebra of Differential Forms
