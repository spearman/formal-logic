...
\begin{itemize}
  \item $R$-modules (Module over a Commutative Ring \S\ref{sec:module}) -- an
    Abelian Group (\S\ref{sec:abelian_group}):
    \[
      (M,+)
    \]
...
an Abelian Group (\S\ref{sec:abelian_group}), $(M, +)$, and an Operation called
\emph{Scalar Multiplication} which is either:
...
A Module Homomorphism is called a \emph{Linear Map}
(or \emph{Linear Transformation} \S\ref{sec:linear_transformation}).
...
A \emph{Bimodule} is an Abelian Group (\S\ref{sec:abelian_group}) that is both a
Left and a Right Module such that the Left and Right Multiplications are
compatible.
...
cf. Differential Calculus (\S\ref{sec:differential_calculus})
...
\subsubsection{Graded Derivation}\label{sec:graded_derivation}

\subsubsection{Antiderivation}\label{sec:antiderivation}
...
% --------------------------------------------------------------------
\subsection{Differential Graded Algebra}\label{sec:differential_graded_algebra}
% --------------------------------------------------------------------
