...
\paragraph{Orthogonal Matrix}\label{sec:orthogonal_matrix}\hfill

An \emph{Orthogonal Matrix} $Q$ is a Real-valued Square Matrix with Columns and
Rows that are \emph{Orthonormal Vectors} (\S\ref{sec:orthonormality}),
...
\subparagraph{Rotation Matrix}\label{sec:rotation_matrix}\hfill
