...
Symplectic Form (\S\ref{sec:symplectic_form})
...
with a Nondegenerate Antisymmetric Bilinear Form (FIXME: ??? Symplectic Form
...
a Nondegenerate Antisymmetric Bilinear Form (FIXME: ??? Symplectic Form
\S\ref{sec:symplectic_form})
