...
a Finite Pre-order is equivalent to a Finite Topological Space
(\S\ref{sec:finite_topological_space}); the number of possible Preorders on a
Finite Set is equal to the number of possible distinct Topologies on the Set
...
\fist Limits (\S\ref{sec:sequence_limit})
