...
\begin{itemize}
  \item Archimedian Field (\S\ref{sec:archimedian_field}) -- e.g. the Real
    Numbers
\end{itemize}
...
\paragraph{Archimedian Field}\label{sec:archimedian_field}\hfill

Archimedian Property (\S\ref{sec:archimedian_property})
