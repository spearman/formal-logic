...
$Sym(R^n)$ (FIXME: clarify)

the Unitary Group (\S\ref{sec:unitary_group}) is a Subgroup of the General
Linear Group
...
\paragraph{Unitary Group}\label{sec:unitary_group}\hfill

$U(n)$ Group of $n \times n$ Unitary Matrices

Subgroup of the General Linear Group

Special Unitary Group (\S\ref{sec:special_unitary})
...
\subparagraph{Classical Group}\label{sec:classical_group}\hfill

Special Linear Groups over $\reals$, $\comps$, and $\quats$ ... and more? TODO
