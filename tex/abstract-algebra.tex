...
a \emph{Differential} (\S\ref{sec:differential}) is a Morphism of a Differential
Object (\S\ref{sec:differential_object}) defining a Chain Complex
called the \emph{Boundary Operator};
