...
The \emph{Syntactic Monoid}, $M(L)$, of a Formal Language
...
\subsubsection{Syntactic Quotient}\label{sec:syntactic_quotient}\hfill \\

\emph{Syntactic Quotient}

The \emph{Right Quotient Subset} of a Subset of a Monoid $S \subset M$
is defined as:
\[
  S / a = \{ s \in M\;|\;sa \in S \}
\]
cf. String\S Quotient \ref{sec:string_quotient}.



\subsubsection{Syntactic Relation}\label{sec:syntactic_relation}\hfill \\
