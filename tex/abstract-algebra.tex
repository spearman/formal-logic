...
Elements of $G$. That is, $H$ is a Normal Subgroup of $G$ if and only
if $\forall g \in G, gH = Hg$, denoted $H \triangleleft G$.
...
Isomorphism Properties for two Groups $G$, $H$:
\begin{itemize}
    \item $|G| = |H|$
