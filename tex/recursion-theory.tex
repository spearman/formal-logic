...
\[
  S ::= \; \mathbf{nat} \;
      | \; \mathbf{bool} \;
      | \; \langle \alpha, \overline{\alpha} \rangle \;
      | \; s \;
      | \; \mu s.S
\]
...
\[
\begin{split}
  \alpha  ::=&\; \uparrow[\alpha]; \beta \;
            | \; \downarrow[\alpha]; \beta \; \\
            |&\; \uparrow[\tilde{S}]; \alpha \;
            | \; \downarrow[\tilde{S}]; \alpha \\
            |&\; \& \{ l_1 : \alpha_1, \ldots, l_n : \alpha_n \} \;
            | \; \oplus \{ l_1 : \alpha_1, \ldots, l_n : \alpha_n \} \\
            |&\; \mathbf{1} \;
            | \; \bot \; \\
            |&\; t \;
            | \; \mu t.\alpha
