...
Power Domain (\S\ref{sec:power_domain})
...
Carbone-Montesi-Schurmann-Yoshida15 -- \emph{Multiparty Session Types
  as Coherence Proofs}; $\otimes$ Input, $\parr$ Output
...
Carbone-Montesi-Schurmann-Yoshida16 -- \emph{Coherence Genrealises
...
by Domain Theory (\S\ref{sec:domain_theory})
