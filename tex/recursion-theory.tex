...
2013 - Meredith, Stay, Drossopoulou - \emph{Policy as Types} -- Hennessy-Milner
Logic (\S\ref{sec:hennessy_milner}); \emph{Deniability} specifications are Open
and describe Necessary Conditions for some Effect to take place; cf. Hoare Logic
specifications describing Sufficient Conditions and are Closed
