...
\fist Homography (Projective Linear Transformation
\S\ref{sec:projective_transformation}) -- ``Projective Collination''
...
Product of a Homography (Projective Linear Transformation
\S\ref{sec:projective_transformation}) and an Automorphic Collineation
(\S\ref{sec:automorphic_collineation})



\paragraph{Automorphic Collineation}\label{sec:automorphic_collineation}\hfill
...
a Projective Range (\S\ref{sec:projective_range}) may be a Projective Line or
else a Conic (\S\ref{sec:conic})
...
Convex Combination (\S\ref{sec:convex_combination})

Convex Hull (\S\ref{sec:convex_hull})
...
2006 - Kock - \emph{Synthetic Differential Geometry}
