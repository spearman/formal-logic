...
Set (Function Root \S\ref{sec:function_root}) of an Irreducible Polynomial
(\S\ref{sec:irreducible_polynomial}) of Degree $2$ in $d+1$ Variables

a \emph{Quadric Surface} is a Surface that may be defined as the Zero Set
(Function Root \S\ref{sec:function_root}) of a Polynomial of Degree $2$
