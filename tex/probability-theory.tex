...
(Mandelbrot97) Models of Price Variation: $L$-Stable Motion (Infinite Variance,
``Tail-driven Variability'' \S\ref{sec:lsm}) + FBM (Long-range Dependence)
...
note all Stable Distributions besides the Normal Distribution have Infinite
Variance
...
\emph{Scaling} (\S\ref{sec:scaling_distribution})
