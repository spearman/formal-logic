...
\begin{itemize}
  ...
  \item \emph{Logical Probability} (``Non-deductive Logic''
    ...
    arbitrary
  \item \emph{Subjective Probability} (``Subjective Bayesianism'') --
  ...
  \item \emph{Frequency Interpretations} -- Relative Frequency (Empirical
    ...
    Outcomes, e.g. (Infinite) ``\emph{Collectives}'' (Von Mises57) where a
    ...
    Probability); issues with limiting Relative Frequencies are that they
    violate Countable Additivity and the Domain of Definition is not a Set-field
    or a $\sigma$-algebra (de Finetti72)
...
``\emph{Collectives}'' (Von Mises57) where a \emph{Place-selection} is an
effective method of selecting indices of Members of a Sequence such that the
selection or not of Index $i$ depends \emph{at most} on the first $i-1$ Outcomes
...
Principle of Maximum Entropy in Classical Probability);
