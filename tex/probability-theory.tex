...
\fist characterizes a Discrete Probability Distribution
...
\fist characterizes a Continuous Probability Distribution
...
characterized by a Probability Mass Function (\S\ref{sec:probability_mass})
...
\subsubsection{Cauchy Distribution}\label{sec:cauchy_distribution}
...
\subsubsection{Kalman Filter}\label{sec:kalman_filter}\hfill
