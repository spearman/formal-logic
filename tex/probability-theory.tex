...
variable ``Data'' (\S\ref{sec:statistical_sample}) for a fixed Hypothesis
...
MLE is Consistent, Equivariant, Asymptotically Normal, and Asymptotically
Optimal (or ``Efficient'')

the MEL Approximates (\S\ref{sec:approximation_theory}) the Bayes Estimator
