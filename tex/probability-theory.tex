...
\subparagraph{Multivariate Hypergeometric Distribution}
...
\subparagraph{Negative Binomial Distribution}
...
\subparagraph{Normal Approximation}\label{sec:normal_approximation}
\hfill \\
...
\paragraph{Multinomial Distribution}\label{sec:multinomial_distribution}
\hfill \\
...
\paragraph{Poisson Distribution}\label{sec:poisson_distribution}
...
\paragraph{Normal Distribution}\label{sec:normal_distribution}
\hfill \\
...
\subparagraph{Standard Normal Distribution}\label{sec:standard_normal}
\hfill \\
...
\paragraph{Gamma Distribution}\label{sec:gamma_distribution}
\hfill \\
...
\subparagraph{Exponential Distribution}\label{sec:exponential_squared}
\hfill \\
...
\subparagraph{$\chi^2$ Distribution}\label{sec:chi_squared}
...
\paragraph{$t$-distribution}\label{sec:t_distribution}
\hfill \\
...
\paragraph{Uniform Distribution}\label{sec:uniform_distribution}
...
\paragraph{Prediction Interval}\label{sec:prediction_interval}
\hfill \\
...
\paragraph{Point Estimator}\label{sec:point_estimator}

\paragraph{Interval Estimator}\label{sec:interval_estimator}



\subsubsection{Bias}\label{sec:bias}

\paragraph{Unbiased Estimate}\label{sec:unbiased_estimate}

\paragraph{Efficient Estimate}\label{sec:efficient_estimate}
\hfill \\
