...
\begin{itemize}
  \item Heteroscedastic (\S\ref{sec:heteroscedasticity}) Errors -- Weighted
    Least Squares (WLS \S\ref{sec:wls})
  \item Correlation between Errors
\end{itemize}
...
the Error is Constant accross Observations (\emph{Heteroscedasticity}
\S\ref{sec:heteroscedasticity})
...
maximizing $\mathcal{L}(B)$ numerically using Iteratively Re-weighted Least
