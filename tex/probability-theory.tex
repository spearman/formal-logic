...
\fist cf. Scale Parameter (\S\ref{sec:scale_parameter})
...
% ------------------------------------------------------------------------------
\subsection{Mixture Distribution}\label{sec:mixture_distribution}
% ------------------------------------------------------------------------------

\subsubsection{Compound Probability Distribution}
...
% ------------------------------------------------------------------------------
\subsection{Geometric Distribution}\label{sec:geometric_distribution}
% ------------------------------------------------------------------------------
...
\item Fat-tailed Distribution (\S\ref{sec:fat_tailed})
...
\subsubsection{Laplace Distribution}\label{sec:laplace_distribution}
...
\emph{L\'evy Alpha-stable Distribution} or \emph{Stable Paretian Distribution}

all Stable Distributions except the Normal Distribution are Fat-tailed
Distributions (\S\ref{sec:fat_tailed}) with undefined Variance
...
Scale Paramter (\S\ref{sec:scale_parameter})
...
Indexed collection of \emph{Dependent} (\S\ref{sec:dependence}) Random
Variables; cf. IID (\S\ref{sec:iid}) Sequences (often of \emph{Observations}
\S\ref{sec:observation})

alternatively: a Probability Distribution over a ``Space of Paths'' (MIT
18.s096) --FIXME: is this a special case ???

the \emph{Outcome} of a Stochastic Process is a particular Path or
``\emph{Sample Function}'' (or ``\emph{Realization}'')

a Process in which each Point is Stochastically Independent
(\S\ref{sec:independence}) is called a \emph{Completely Random Process} (e.g. a
