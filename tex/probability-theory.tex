...
or \emph{Supervised Learning}

cf. Cluster Analysis (Unsupervised Learning \S\ref{sec:cluster_analysis})
...
cf. Classification (Supervised Learning \S\ref{sec:statistical_classification})
