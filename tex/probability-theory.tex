...
% ==============================================================================
\section{Statistical Sample}\label{sec:sample}
% ==============================================================================
...
in a \emph{Hypothesis} (\S\ref{sec:hypothesis}), i.e. an Assertion or conjecture
concerning one or more Statistical Populations (\S\ref{sec:population}).
...
\emph{Test Statistic} (\S\ref{sec:test_statistic})
...
\emph{Critical Region} (\S\ref{sec:critical_region})
...
A \emph{Statistical Hypothesis} is an Assertion (\S\ref{sec:assertion}) or
conjecture concerning one or more Populations (\S\ref{sec:population}).
