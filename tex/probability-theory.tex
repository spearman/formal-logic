...
Distribution (\S\ref{sec:probability_distribution}) that ``generated'' the Data.
...
that ``generated'' the Data; a Statistical Model (\S\ref{sec:statistical_model})
$(S,\mathcal{P})$ is a Sample Space (\S\ref{sec:sample_space}) $S$ together with
a Set of Probability Distributions $\mathcal{P}$ on $S$
