...
\fist Bayesian Networks (\S\ref{sec:bayes_network}), Intervention Model
(Causal Inference \S\ref{sec:intervention_model})
...
Bayesian Network (\S\ref{sec:bayes_network}) -- ``Dependency structure'';
...
\subparagraph{Intervention Model}\label{sec:intervention_model}\hfill
