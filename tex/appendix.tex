...
A Map or Mapping is a general Term that can mean either a Function or a
...
\url{https://blog.compiler.ai/2021/05/06/verification-is-tcbpb-reduction/}
...
(nlab): Metatheoretic Equivalence Relation on Syntactic Expressions which states
that two Syntactic Expressions are Equivalent if they have the same Meaning

Definitional Equality encompasses both Syntactic Equality and
$\alpha$-equivalence
...
\begin{itemize}
  ...
  \item Fundamental Theorem of Algebraic Geometry (Hilbert's Nullstellensatz)
  ...
  \item Fundamental Theorem of Random Fields (\S\ref{sec:random_fields_theorem})
    ... TODO
  \item Fundamental Lemma of Calculus of Variations ... TODO
  \item ...
\end{itemize}
