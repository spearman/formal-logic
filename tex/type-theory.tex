...
Calculus of Constructions (\S\ref{sec:coq}): Coq
...
\fist $\lambda$-expression (\S\ref{sec:lambda_expression})
...
\subsubsection{De Bruijn Index}\label{sec:debruijn_index}\hfill
...
\emph{$beta$-expansions} (reverse Contractions). A Conversion from
Term $M$ to Term $N$ is denoted $M =_* N$.
...
\subsubsection{Product Type}\label{sec:product_type}\hfill
...
\subsubsection{Sum Type}\label{sec:sum_type}\hfill
...
\subsubsection{Infinite Data Type}\label{sec:infinite_datatype}\hfill

(Proof Object) Definition by Recursion: Proof by Induction



\subsubsection{Tree}\label{sec:tree_type}\hfill
...
\subsubsection{Forest}\label{sec:forest_type}\hfill
...
\paragraph{Predicative Polymorphism}
\label{sec:predicative_polymorphism}\hfill
...
\paragraph{Impredicative Polymorphism}
\label{sec:impredicative_polymorphism}\hfill
...
\subsubsection{Subtype Polymorphism}\label{sec:subtype_polymorphism}

\paragraph{Subtype}\label{sec:subtype}\hfill
...
\paragraph{Power Type}\label{sec:power_type}
...
\paragraph{Principal Type}\label{sec:principal_type}
...
% ====================================================================
\section{Type Function}\label{sec:type_function}
% ====================================================================
...
(\S\ref{sec:type_function}), or the Type of a Higher-order Type
...
\S\ref{sec:system_f}); Terms depending on Types (Polymorphism
