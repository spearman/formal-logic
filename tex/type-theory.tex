...
% --------------------------------------------------------------------
\subsection{Product Type}\label{sec:product_type}
% --------------------------------------------------------------------

% --------------------------------------------------------------------
\subsection{Sum Type}\label{sec:sum_type}
% --------------------------------------------------------------------

% --------------------------------------------------------------------
\subsection{Coproduct Type}\label{sec:coproduct_type}
% --------------------------------------------------------------------
...
A Polymorphic Function Dependent Product Type
(\S\ref{sec:dependent_product}):
\[
  \Pi(A:\mathcal{U}) A \rightarrow C
\]
...
(\S\ref{sec:simplytyped_conjunctive}) is no longer ``Simply-typed''
because it allows for Terms to have more than one Type.
...
\subsubsection{System F}\label{sec:system_fsub}
...
Intensional Martin-L\"of Type Theory: Internal Language
