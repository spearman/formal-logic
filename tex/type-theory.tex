...
Parametrically Polymorphic (\S\ref{sec:parametric_polymorphism})
...
Contravariant Functors on the Argument Type.
...
Internal Language (\S\ref{sec:internal_language}) of Closed
