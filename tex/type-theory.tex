...
\begin{itemize}
  ...
  \item ATS (\S\ref{sec:ats}) -- Views (Linear Proofs), Viewtypes
    (Linear Types \S\ref{sec:viewtype})
\end{itemize}
...
Proposition (a \emph{View}), $V$, and a Value of (Non-linear) Type,
$T$.
...
\emph{Viewtype} (\S\ref{sec:viewtype})
