...
Computational Monad: Free Monad (\S\ref{sec:free_monad})
...
most often seen in Strict Languages

subsumed by Monads: ``Lazy State'' and ``Lazy Writer'' cannot be
captured by any Effect System (E. Kmett)

Continuations are not representable as Algebraic Effects

(Pretnar - 2010 - \emph{The Logic and Handling of Algebraic Effects}):
%FIXME
