...
Monadic Reification (Layered Monads \S\ref{sec:layered_monad})
...
Proto-operations: Monadic Reflection (\S\ref{sec:type_reflection}),
Monadic Reification (\S\ref{sec:reification})
...
$\class{E}(\mathfrak{n})$ Identity Monad

$\class{E}(\mathfrak{p})$ Lifting
...
Algebraic Operations (\emph{Effect Constructors}: giving rise to the
Effects) are Dual to Effect Handlers (\emph{Effect Deconstructors}:
