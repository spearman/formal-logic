...
\begin{enumerate}
  \item $A$ is a Set, $A$ is a Proposition, $A$ is an Expectation, $A$
    is a Task
  \item $A$ and $B$ are Equal Sets
  \item $a$ is an Element of $A$, $a$ is a Proof of $A$, $a$ is a
    Realization of $A$, $a$ is a Method for doing $A$
  \item $a$ and $b$ are Equal Elements of Set $A$
\end{enumerate}
...
Type Theory, Proof Theory, Algebra (Preorders)
\\
\begin{tabular}{| l | l |}
\hline
...
\end{tabular}
\\
\begin{tabular}{| l | p{2.5cm} | p{4.5cm} | p{3cm} |}
\hline
