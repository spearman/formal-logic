...
\paragraph{Mutually Recursive Data Type}\label{sec:mutually_recursive_datatype}\hfill
...
\paragraph{Equirecursive Data Type}\label{sec:equirecursive_datatype}\hfill
