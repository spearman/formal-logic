...
\emph{Stratified Type Theory}, while (1.) is ``\emph{Impredicative}'', since
$Type : BigType$, if $B : Type$, then $\forall X : Type.B : Type$ is an
expression Quantifying over $Typ$ comprising the Product Type being defined as
one of its Elements
