...
A \emph{Formal Language}, $L$, is a possibly infinite Subset of all
possible \emph{Expressions} (or \emph{Words}) over a possibly infinite
\emph{Alphabet} of \emph{Symbols}, $\Sigma$. This infinite Set
$\Sigma^*$ is the \emph{Kleene star} or \emph{Free Monoid}
(\S\ref{sec:free_monoid}) of $\Sigma$; the smallest Superset of
...
\begin{description}
    ...
    a finite set of Productions over the Expressions of a Free Monoid
...
\[
    \mathcal{A} = \{ Alphabets \},\: \mathcal{V} = \{ Free Monoids \}
\] \[
...
\item Definition of a Language in terms of a Free Monoid:
\[
