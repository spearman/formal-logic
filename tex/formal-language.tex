...
and the Tokens are parsed as a Context-free (\S\ref{sec:context_free})
or Attribute Phrase (\S\ref{sec:attribute_grammar}) Syntax.

Prior to \emph{Scanning}, a \emph{Lexer} may perform its own
Tokenization. The Scanning stage first recognizes the Token strings as
\emph{Lexemes}, usually achieved by a Finite State Machine.
