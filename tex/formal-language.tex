...
For a Formal Language, $L$, a Formal Theory, $\mathcal{T}$,
is a Subset of a Conceptual Class of \emph{Elementary Expressions},
$\mathcal{E}$, consisting of \emph{Elementary Theorems} considered to
be \emph{True}.
