...
the Set of all Endomorphisms forms a \emph{Transformation Monoid}
...
cf. Simplicial Complex (\S\ref{sec:simplicial_compex}) -- a Set of
...
\paragraph{Globular Set}\label{sec:globaular_set}\hfill
