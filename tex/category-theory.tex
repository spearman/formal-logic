...
\emph{Cartesian Differential Operator} $D_\times$

$D_\times : \cat{X}(X,Y) \implies \cat{X}(X \times X \to Y)$

(Note: the paper writes $D$ as an inference rule)
...
2019 - Cruttwell et al. - \emph{Monoidal Reverse Differential Categories}
...
2019 - Cockett et al. - \emph{Reverse Derivative Categories}
...
\[
  R : \cat{X}(A,B) \implies \cat{X}(A \times B \to A)
\]
