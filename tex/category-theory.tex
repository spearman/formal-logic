...
\HandRight\; Note that in Constructions where a Functor appears, if
...
% --------------------------------------------------------------------
\subsection{Strong Monad}\label{sec:strong_monad}
% --------------------------------------------------------------------
...
% --------------------------------------------------------------------
\subsection{$A$-algebra}\label{sec:a_algebra}
\cite{jacobs-heunen-hasuo09}
% --------------------------------------------------------------------
...
% ====================================================================
\section{Coherence Condition}\label{sec:coherence_condition}
% ====================================================================
