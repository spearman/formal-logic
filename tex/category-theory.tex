...
Pointed Endofunctor (\S\ref{sec:pointed_endofunctor}) $E : \cat{C}
\rightarrow \cat{C}$ with Natural Transformation $\sigma : 1_\cat{C}
\rightarrow E$ as the Unit; Well-pointed exactly when the Monad is
...
An alternative to Monads for Computational Effects is Algebraic
Effects (\S\ref{sec:algebraic_effect}), more often seen in Strict
Languages
