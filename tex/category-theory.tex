...
\item [Man] or $\cat{Diff} all Smooth Manifolds and Smooth Maps
...
\paragraph{Constrained Category}\label{sec:constrained_category}\hfill
...
Spectrum (\S\ref{sec:cohomology_spectrum})-- generalized Cohomology Theory
