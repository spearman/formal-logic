...
A \emph{Concrete Category} is pair, $\langle \mathbf{C},U \rangle$,
where $\mathbf{C}$ is a Category and $U$ is a Faithful Functor $U :
...
\begin{itemize}
\item $ \langle X,Y \rangle \neq \langle X',Y' \rangle \rightarrow
...
\begin{itemize}
    ...
    \item Initial and Terminal Objects (\S\ref{subsec:universal_property})
\end{itemize}
