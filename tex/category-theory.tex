...
% --------------------------------------------------------------------
\subsection{Representable Category}\label{sec:representable_category}
% --------------------------------------------------------------------
...
\subsubsection{Locally Small Category}\label{sec:locally_small}

A Category is \emph{Locally Small} if all Hom-sets of the Category are
Sets and not Proper Classes.
% FIXME definition in terms of hom-sets

There is at least one canonical Functor from any Locally Small
Category into $\mathbf{Set}$.



% --------------------------------------------------------------------
\subsection{Complete Category}\label{sec:complete_category}
% --------------------------------------------------------------------

A \emph{Complete Category} is a Category where all Small Limits
(\S\ref{sec:limit}) exist.
...
\subsubsection{Monomorphism}\label{sec:monomorphism}
...
\subsubsection{Paramorphism}\label{sec:paramorphism}

Primitive Recursion (\S\ref{sec:primitive_recursion})



\paragraph{Catamorphism}\label{sec:catamorphism}
...
\subsubsection{Apomorphism}\label{sec:apomorphism}

Primitive Corecursion (\S\ref{sec:primitive_corecursion})



\paragraph{Anamorphism}\label{sec:anamorphism}
\hfill \\
\emph{Unfold}
...
\subsubsection{Hylomorphism}\label{sec:hylomorphism}
...
\subsubsection{Metamorphism}\label{sec:metamorphism}
...
% --------------------------------------------------------------------
\subsection{Factors}\label{sec:morphism_factor}
% --------------------------------------------------------------------
...
\]
each half of which is a \emph{Representable Functor}
\S\ref{sec:representable_functor}.
...
\[
  F_\times : \mathbf{C} \times \mathbf{C} \rightarrow \mathbf{C}
\]
...
Constant Functor $\Delta(A) \in \mathbf{C}^\mathbf{J}$ with fixed $A$
...
\subsubsection{Exponential}\label{sec:category_exponential}
...
\]
where $\lambda f \times 1_A : X \times A \rightarrow B^A \times A$.
The Morphisms $f$ and $\lambda f$ are called \emph{Exponential
  Adjoints}. The $\epsilon$ function is the Counit of the Adjunction
(\S\ref{sec:adjoint}) between the Product Functor and the Exponential
Functor.
...
Object (\S\ref{sec:initial_terminal}) is a Cartesian Closed Category
...
\subsubsection{Colimit} \label{sec:colimit}
...
% --------------------------------------------------------------------
\subsection{Opposite Categories}\label{sec:opposite_category}
% --------------------------------------------------------------------
...
Category of Graphs and Graph Homomorphisms. Cf. Simplicial Sets
(\S\ref{sec:simplicial_set}).



\subsubsection{Arrow Categories}\label{sec:arrow_category}
...
\subsubsection{Cones}\label{sec:category_cone}
...
\subsubsection{Finitely Presented Category}\label{sec:finitely_presented}
...
% --------------------------------------------------------------------
\subsection{Simplex Category}\label{sec:simplex_category}
% --------------------------------------------------------------------

% --------------------------------------------------------------------
\subsection{Simplicial Set}\label{sec:simplicial_set}
% --------------------------------------------------------------------
