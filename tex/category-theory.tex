...
&#x261e; The reason for taking Isomorphism Classes of Cospans is that
...
\begin{itemize}
  ...
  \item Semantics of Signal Flow Graphs (\S\ref{sec:signal_flowgraph})
\end{itemize}
...
\[
  X + Y \xrigharrow{e} \overline{N} \xrightarrow{m} N
\]
...
(\S\ref{sec:cospan_bicategory}) in $\cat{C}$ with $2$-morphisms given
by Maps of Cospans in which Bicategory every Morphisms in $\cat{M}$
has a Right Adjoint
