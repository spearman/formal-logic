...
\subsubsection{Applicative Comonad}\label{sec:applicative_comonad}
...
Loop Combinator in Functional Reactive Programming (\S\ref{sec:frp}),
Reactive Types (\S\ref{sec:reactive_type})
...
\paragraph{Well-pointed Topos}\label{sec:wellpointed_topos}
\hfill \\
