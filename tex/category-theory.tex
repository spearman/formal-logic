...
The Canonical Commutative Isomorphism $A \times B \cong B \times A$
is:
\[
    \langle p_2, p_2 \rangle : A \times B \rightarrow B \times A
\]
...
$\mathbf{Sets}$ is the Disjoint Union (\S\ref{subsec:disjoint_union}).

Like Products, Coproducts are also Commutative and Associative up to
Isomorphism.
...
\end{enumerate}
This provides that, by the Universal Mapping Property of Exponentials:
\[
